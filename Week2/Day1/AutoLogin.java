	...
	public static void main(String[] args) {
		...
		//BrowserContext
				BrowserContext context = browser.newContext(new Browser.NewContextOptions()
						.setStorageStatePath(Paths.get("login_leaftaps_demo.json")));		
		// Open a new page
		 ...
		 * page.type("#username", "demosalesmanager"); // page.pause(); // Type the
		 * password page.locator("#password").type("crmsfa"); // Click Login
